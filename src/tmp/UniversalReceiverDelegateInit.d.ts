...
interface UniversalReceiverDelegateInitInterface extends ethers.utils.Interface {
  functions: {
...
export class UniversalReceiverDelegateInit extends BaseContract {
  ...
  interface: UniversalReceiverDelegateInitInterface;
